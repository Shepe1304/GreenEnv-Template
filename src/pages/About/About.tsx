    ...
    <>
      ...
      <main className="about">
        <div className="about--text_container">
          <div className="about--who">
            ...
            <div className="about--text">
              ...
              nhằm thay đổi hành vi và truyền cảm hứng để cộng đồng Việt Nam
              cùng hành động.
            </div>
          </div>
        </div>
        <div className="about--images">
          ...
          <img src={img2} alt="people determined in teamworking" />
        ...
        <div className="about--text_container">
          <div className="about--what">
            ...
            <div className="about--text">
              ...
              tỏa tinh thần, trách nhiệm và kêu gọi những hành động thiết thực
              từ mỗi cá nhân, gia đình, xã hội và cộng đồng để xây dựng môi
              trường sống của chúng ta xanh, sạch, đẹp, bền vững.
            </div>
          </div>
        </div>
      </main>
